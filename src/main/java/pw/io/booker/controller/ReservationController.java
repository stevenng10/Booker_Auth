...
public class ReservationController {
	...
	@PostMapping
	public List<Reservation> saveAll(@RequestHeader String token, @RequestBody List<Reservation> reservations) {
	...
	@PutMapping
	public List<Reservation> updateAll(@RequestHeader String token, @RequestBody List<Reservation> reservations) {
		for (Reservation reservation : reservations) {
			if (!reservationRepository.findById(reservation.getReservationId()).isPresent()) {
	...
	@DeleteMapping
	public List<Reservation> deleteAll(@RequestHeader String token,
	...
	public Reservation getReservation(@RequestHeader String token, @PathVariable("reservationId") int reservationId) {
		return reservationRepository.findById(reservationId).get();
	}

	@PutMapping("/{reservationId}")
	public Reservation updateReservation(@RequestHeader String token, @PathVariable("reservationId") int reservationId,
	...
	public Reservation deleteReservation(@RequestHeader String token,
