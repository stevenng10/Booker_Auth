...
public class FeedbackController {
	...
	@GetMapping
	public List<Feedback> getFeedback(@RequestHeader String token, @PathVariable("reservationId") int reservationId) {
		return reservationRepository.findById(reservationId).get().getFeedbacks();
	}

	@PostMapping
	public List<Feedback> saveFeedback(@RequestHeader String token, @PathVariable("reservationId") int reservationId,
	...
	@PutMapping
	public List<Feedback> updateFeedback(@RequestHeader String token, @PathVariable("reservationId") int reservationId,
			@RequestBody List<Feedback> feedbacks) {
	...
	@DeleteMapping
	public List<Feedback> deleteFeedback(@RequestHeader String token, @PathVariable("reservationId") int reservationId,
